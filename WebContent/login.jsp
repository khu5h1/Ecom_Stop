...
<header>
	...
	<div class="signup-header">
	 	<h2>Login to <mark>EcomStop</mark></h2>
	</div>
	 ...
	 <input type="hidden" name="page" value="login-form">
	 	...
	 	<p>
	 		New to EcomStop? <a href="Controller?page=sign-up" style="color:#F24638;">Create Account</a>
	 	</p>
	 </form>
	<br><br><br>
	<footer style="position: fixed;bottom: 0;left: 0;width: 100%;">
		<div class="footer">  
	      <a href="Controller?page=index"> EcomStop</a>
	    </div>
	</footer>
